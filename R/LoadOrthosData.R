...
#' 
#' @details 
#' The function pre-caches a set of pre-trained orthosData keras models for a given organism.
...
#' 
#' \strong{DeltaEncoder}: The encoder component of a conditional Variational Autoencoder (cVAE).
#' 
...
#' 
#' \strong{DeltaDecoder}: The decoder component of the same cVAE as above. Used to produce the decoded version 
...
#'
#' Download in cache HDF5 and RDS component files for an othosData contrast database from ExperimentHub.
...
#'
#' @details The orthosData  contrast database contrains over 100,000 differential gene expression experiments
...
#' 
#' The ~20,000 gene features/organism used in the database are "sanctioned" according to several criteria
